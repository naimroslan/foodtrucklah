...
@section('content')
    ...
    <div class="products">
        <div class="container">
            <div class="col-md-9 products-w3ls-right">
                {{-- @if(Session::get('sms'))
...
{{--                        <h3>Dear {{Session::get('customer_username') }}.</h3> --}}
                        <h4 class="text-center">We've to know which payment method would you want.</h4>
                    </div>
                    <div class="card mt-4">
